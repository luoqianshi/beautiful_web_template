...
> 来源：[Design Prompts](https://www.designprompts.dev/vaporwave)
...
| 模式 | 🌙 深色模式 (Dark) |
| 字体类型 | mono |
| 描述 | A nostalgic, neon-drenched journey into 80s retro-futurism. High-contrast neon pinks and cyans against deep void purples. Digital grids, glowing horizons, surreal sunset gradients, and CRT scanline overlays create an immersive synthetic world. |
